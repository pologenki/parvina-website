  ...
  <div class="portfolio-container">
    ...
    <div class="swiper portfolio-swiper">
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <div class="portfolio-card">
            ...
            <div class="portfolio-content">
              <h3>Meeting with Vietnamese supplie</h3>
              <p>Almonds, walnuts and cashews from USA, Turkey and Vietnam</p>
              <div class="project-stats">
                <div class="stat">
                  <span class="stat-label">Strengthening partnerships and supply reliability.</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="swiper-slide">
          <div class="portfolio-card">
            <div class="card-image" data-image-src="/img/img004.jpg" data-image-alt="Premium nuts import">
              <img src="/img/img004.jpg" alt="Premium nuts import" class="portfolio-image">
              <div class="card-overlay">
                <div class="zoom-icon">
                  <i class="fas fa-expand"></i>
                </div>
            ...
            <div class="portfolio-content">
              ...
              <div class="project-stats">
                <div class="stat">
                  <span class="stat-label">Building strategic connections.</span>
                </div>
              </div>
            </div>
          </div>
