    ...
    <div class="portfolio-container">
      ...
      <div class="flip-slider-wrap">
        <div class="flip-slider-track" id="portfolioTrack"></div>
                <p style="text-align:center;font-size:0.68rem;color:#b0b0b0;letter-spacing:0.12em;text-transform:uppercase;margin-top:1rem;">Click card to flip · Click "View Photo" to zoom</p>
